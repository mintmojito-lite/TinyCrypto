...
std::array<uint8_t, HMAC_SHA256::HASH_SIZE> HMAC_SHA256::mac(const uint8_t *key,
                                                             size_t key_len,
                                                             const uint8_t *msg,
                                                             size_t msg_len) {
...
bool HMAC_SHA256::verify(const uint8_t *key, size_t key_len, const uint8_t *msg,
                         size_t msg_len,
                         const uint8_t expected_mac[HASH_SIZE]) {
